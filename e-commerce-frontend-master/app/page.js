          ...
          >
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <Link href="/products/womens">
                <div
                  className={`glass-card p-6 text-center hover:shadow-[0_0_20px_rgba(141,125,250,0.3)] transition-all duration-300 group transform relative ${
                    categoriesVisible ? "animate-scaleIn" : "opacity-0 scale-90"
                  }`}
                  style={{ animationDelay: "0.6s" }}
                >
                  {/* Cover Image */}
                  {categoryImages.womens && (
                    <div
                      className="absolute inset-0 rounded-lg bg-cover bg-center opacity-20 group-hover:opacity-30 transition-opacity duration-300"
                      style={{
                        backgroundImage: `url(${categoryImages.womens})`,
                      }}
                    />
                  )}
                  ...
                  <div className="absolute top-2 right-2 z-10">
                    <label className="cursor-pointer bg-[#8D7DFA] hover:bg-[#7C6CE8] text-white rounded-full w-8 h-8 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg">
                      <span className="text-lg font-bold">+</span>
                      <input
                        type="file"
                        className="hidden"
                        accept="image/*"
                        onChange={(e) => handleCategoryImageUpload("womens", e)}
                      />
                    </label>
                  </div>
              ...
              <Link href="/products/mens">
                ...
                >
                  ...
                  {categoryImages.mens && (
                    <div
                      className="absolute inset-0 rounded-lg bg-cover bg-center opacity-20 group-hover:opacity-30 transition-opacity duration-300"
                      style={{ backgroundImage: `url(${categoryImages.mens})` }}
                    />
                  )}
                  ...
                  <div className="absolute top-2 right-2 z-10">
                    <label className="cursor-pointer bg-[#8D7DFA] hover:bg-[#7C6CE8] text-white rounded-full w-8 h-8 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg">
                      ...
                      <input
                        ...
                        className="hidden"
                        accept="image/*"
                        onChange={(e) => handleCategoryImageUpload("mens", e)}
                      />
                    </label>
                  </div>
                  ...
                  <div className="absolute top-2 right-2 z-10">
                    <label className="cursor-pointer bg-[#8D7DFA] hover:bg-[#7C6CE8] text-white rounded-full w-8 h-8 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg">
                      ...
                      <input
                        ...
                        accept="image/*"
                        onChange={(e) =>
                          handleCategoryImageUpload("accessories", e)
                        }
                      />
                    </label>
                  </div>
              ...
              <Link href="/products/footwear">
                ...
                >
                  {/* Cover Image */}
                  {categoryImages.footwear && (
                    <div
                      className="absolute inset-0 rounded-lg bg-cover bg-center opacity-20 group-hover:opacity-30 transition-opacity duration-300"
                      style={{
                        backgroundImage: `url(${categoryImages.footwear})`,
                      }}
                    />
                  )}
                  ...
                  <div className="absolute top-2 right-2 z-10">
                    <label className="cursor-pointer bg-[#8D7DFA] hover:bg-[#7C6CE8] text-white rounded-full w-8 h-8 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg">
                      ...
                      <input
                        ...
                        accept="image/*"
                        onChange={(e) =>
                          handleCategoryImageUpload("footwear", e)
                        }
                      />
                    </label>
                  </div>
